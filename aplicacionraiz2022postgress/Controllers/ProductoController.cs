...
namespace appcomics.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Name,Clase,Subclase,Estado,Descripcion,Precio,PorcentajeDescuento,ImageName,Status")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Clase,Subclase,Estado,Descripcion,Precio,PorcentajeDescuento,ImageName,Status")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
